@component('components.modal',['id' => 'cart-modal', 'classes' => ['cart-modal', 'modal--loading']])
  <h2 class="modal__content-title modal__content-title--left">{{ __('Cart contents', 'tristel') }}</h2>
  <form>
    ...
    <a href="{!! wc_get_cart_url() !!}" class="btn">{{ __('Checkout', 'tristel') }}</a>
  </form>
@endcomponent
